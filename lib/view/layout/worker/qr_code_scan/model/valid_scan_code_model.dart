class ValidScanCodeModel {
  ...
  ValidScanCodeModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    ticketIdentifier = json['ticket_identifier'];
    // if (json['car_images'] != null) {
    //   carImages = <Null>[];
    //   json['car_images'].forEach((v) {
    //     carImages!.add(Null.fromJson(v));
    //   });
    // }
